...
const quizData = [
    ...
    {
        type: "fill-blank",
        question: "A string in C must end with a special character called ______.",
        correctAnswer: "null character",
        keywords: ["null", "\\0", "null character"]
    },
    ...
    // Question 4 - Multiple Fill Blank
    {
        type: "multiple-fill-blank",
        question: "The function ______ copies a string, while ______ compares two strings.",
        blanks: [
            { correctAnswer: "strcpy", keywords: ["strcpy"] },
            { correctAnswer: "strcmp", keywords: ["strcmp"] }
        ]
    },
    ...
    {
        type: "short-answer",
        question: "Explain why '\\0' is important in C strings.",
        keywords: ["end", "terminate", "null", "stop", "string"],
        minKeywords: 2
    },
    ...
    // Question 9 - Fill Blank
    {
        type: "fill-blank",
        question: "The function ______ is used to compare two strings in C.",
    ...
    {
        type: "multiple-choice",
        question: "Which of the following correctly matches the string function with its purpose?",
        options: [
            "strcpy() - Compare two strings",
            "strlen() - Copy a string",
            "strcat() - Concatenate two strings",
            "strcmp() - Find string length"
        ],
        correctAnswer: 2
    }
]; // The end, abes
