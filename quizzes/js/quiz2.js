...
// ============================================================
const QUIZ_PASSWORD = "CP2theBEST"
...
//QUEST 1
    {
        type: "multiple-choice",
        question: "According to the variable naming rules in C, which of the following statements is true?",
        options: [
            "Variable names can start with a digit.",
            "Keywords such as for and while can be used as variable names.",
            "Variable names are case sensitive, meaning int x; and int X; declare different variables.",
            "Variable names can contain special characters such as @ and #."
        ],
...
//QUEST 2
    {
        type: "multiple-choice",
        question: "When evaluating the expression 100 / 5 % 2, where both the division (/) and modulus (%) operators share the exact same precedence, how is the evaluation order determined?",
        options: [
            "The modulus operator must always be applied first.",
            "The order of evaluation is determined by associativity from Left to Right.",
            "The operation fails because precedence cannot resolve identical rankings.",
            "The order of evaluation is determined by associativity from Right to Left."
        ],
        correctAnswer: 1 // Answer, indexing start from zero '0'
    },
...
//QUEST 3
    {
        type: "multiple-choice",
        question: "Which of the following escape sequences is used to move the output cursor to the beginning of the next line? ",
        options: [
            "\\t",
            "\\n",
            "\\a",
...
//QUEST 4
    {
        type: "fill-blank",
        question: "A structured, step-by-step process for developing quality software that ensures it meets stakeholder needs systematically is referred to as the ______.",
        correctAnswer: "PDLC",
        keywords: ["pdlc", "Pdlc", " Program Development Life Cycle", "program development life cycle"]
    },

//QUEST 5
    {
        type: "fill-blank",
        question: "In C programming, when using the postfix increment method (e.g., a++), the value of the operand will be altered ______ it is used.",
        correctAnswer: "after",
